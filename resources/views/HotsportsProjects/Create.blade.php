...
@endif
            <form class="space-y-4 mt-4" action="{{ route('hprojects.store') }}" method="POST"
                ...
                <div>
                    ...
                    <textarea name="content" class="w-full h-40 p-2 border border-gray-300 rounded-b" placeholder="Enter text here..."
                        required></textarea>
                </div>
