    ...
    <div class="w-full h-screen overflow-y-auto  ">
        ...
        <div class="p-10 ">
            <div class="flex-1 p-6 ">
                <h1 class="text-3xl font-semibold">Hotsports Projects</h1>
                <div class="flex justify-between items-center my-6">
                    <div class=" text-xl font-bold">
                        All ({{ $projects->count() }})
                    </div>
                    <a href="{{ route('hprojects.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded-lg">Add New</a>
                    <div>
                                ...
                                <div class=" flex flex-col ">
                                    ...
                                    <div class="actions">
                                        <div class="w-full flex mt-2">
                                            <a href="{{ route('hprojects.edit', $project->id) }}"
                                                class="bg-blue-600 text-white px-4 py-2 rounded mr-2 hover:bg-blue-500">Edit</a>
                                                <form action="{{ route('hprojects.destroy', $project->id) }}" method="POST" class="inline-block" onsubmit="confirmDelete(event)">
                                                    @csrf
                                                    @method('DELETE')
