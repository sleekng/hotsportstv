...
<body class="preloader cursor-anim-enable dark-nav">
	...
	<div class="preloader__logoload-box">
		<img class="preloader__logo vertical" src="{{ asset('assets/images/Homepage/Main Logos/HS Media Group@2x.png') }}" alt="logo">
		...
		<div class="pos-rel height-100perc">
			...
			<div class="nav-information">
				...
				<div>
					...
					<div class="nav-fade-anim js-nav-anim margin-top-10">
						<a href="#" class="subhead-xxs nav-text-color text-hover-to-red js-pointer-small">+234 803 0945
							660</a><br>
						<a href="#" class="subhead-xxs nav-text-color text-hover-to-red js-pointer-small">+234 809 7869
							971</a>
					</div>
				</div><!-- nav-phone end -->
			...
			<div class="nav-copyright text-right">
				<p class="copyright-style nav-fade-anim js-nav-anim">
					&copy; Copyright 2021 HS Group. Created by <a href="#" class="text-weight-700 js-pointer-small">Zoar
						Imaginarium</a>
				</p>
	...
	<main class="js-animsition-overlay" data-animsition-overlay="true">
					...
					<div class="text-center tr-delay-08">
                            ...
                            <h2 class="column-l-r-margin-10 headline-big-lg js-scrollanim margin-bottom-60">
                                <span class="hidden-box d-block">
                                    <span class="hidden-box d-block">
                                        <span class="anim-slide tr-delay-01 text-color-white">See Our Studios</span>
                                    </span>
                            </h2><!-- title end -->
		...
		<section class="pos-rel section-bg-dark-2">
			...
			<div class="pos-rel padding-top-bottom-60">
				<!-- title start -->
				<h2 class="headline-l text-center hidden-box margin-top-bottom-60">
					<span class="anim-slide js-scrollanim text-color-red">Exterior</span>
				</h2><!-- title end -->
				...
				<div class="js-isotope-grid-box container full padding-top-30">
						...
						<!-- grid-item start -->
						<div class="padding-top-40 grid-item-33-50-100 js-isotope-grid-item margin-top-30">
							<a href="{{ asset('assets/images/Studios/5.png') }}"
								class="grid-margin-box js-photo-popup js-pointer-zoom">
								<div class="anim-img-scale js-img-scale">
									<img class="anim-img-scale__inner"
										src="{{ asset('assets/images/Studios/5.png') }}"
										alt="Studio Images">
								</div>
							</a>
						</div><!-- grid-item end -->
						...
						<!-- grid-item start -->
						<div class="padding-top-40 grid-item-33-50-100 js-isotope-grid-item margin-top-30">
							<a href="{{ asset('assets/images/Studios/6.png') }}"
								class="grid-margin-box js-photo-popup js-pointer-zoom">
								<div class="anim-img-scale js-img-scale">
									<img class="anim-img-scale__inner"
										src="{{ asset('assets/images/Studios/6.png') }}"
										alt="Studio Images">
								</div>
							</a>
						</div><!-- grid-item end -->
						...
						<!-- grid-item start -->
						<div class="padding-top-40 grid-item-33-50-100 js-isotope-grid-item margin-top-30">
							<a href="{{ asset('assets/images/Studios/8.png') }}"
								class="grid-margin-box js-photo-popup js-pointer-zoom">
								<div class="anim-img-scale js-img-scale">
									<img class="anim-img-scale__inner"
										src="{{ asset('assets/images/Studios/8.png') }}"
										alt="Studio Images">
								</div>
							</a>
						</div><!-- grid-item end -->
						...
						<!-- grid-item start -->
						<div class="padding-top-40 grid-item-33-50-100 js-isotope-grid-item margin-top-30">
							<a href="{{ asset('assets/images/Studios/7.png') }}"
								class="grid-margin-box js-photo-popup js-pointer-zoom">
								<div class="anim-img-scale js-img-scale">
									<img class="anim-img-scale__inner"
										src="{{ asset('assets/images/Studios/7.png') }}"
										alt="Studio Images">
								</div>
							</a>
						</div><!-- grid-item end -->
		...
		<section class="pos-rel section-bg-dark-2">
			...
			<div class="pos-rel padding-top-bottom-60">
				<!-- title start -->
				<h2 class="headline-l text-center hidden-box margin-top-bottom-60">
					<span class="anim-slide js-scrollanim text-color-red">Ground Floor</span>
				</h2><!-- title end -->
					...
					<div class="js-isotope-grid-box container full padding-top-30">
						...
						<div class="padding-top-40 grid-item-33-50-100 js-isotope-grid-item margin-top-30">
							<a href="{{ asset('assets/images/Studios/5.png') }}"
								...
								<div class="anim-img-scale js-img-scale">
									<img class="anim-img-scale__inner"
										src="{{ asset('assets/images/Studios/9.png') }}"
										alt="Studio Images">
								</div>
							</a>
						</div><!-- grid-item end -->
						...
						<div class="padding-top-40 grid-item-33-50-100 js-isotope-grid-item margin-top-30">
							<a href="{{ asset('assets/images/Studios/6.png') }}"
								...
								<div class="anim-img-scale js-img-scale">
									<img class="anim-img-scale__inner"
										src="{{ asset('assets/images/Studios/10.png') }}"
										alt="Studio Images">
								</div>
							</a>
						</div><!-- grid-item end -->
						...
						<div class="padding-top-40 grid-item-33-50-100 js-isotope-grid-item margin-top-30">
							<a href="{{ asset('assets/images/Studios/8.png') }}"
								...
								<div class="anim-img-scale js-img-scale">
									<img class="anim-img-scale__inner"
										src="{{ asset('assets/images/Studios/11.png') }}"
										alt="Studio Images">
								</div>
							</a>
						</div><!-- grid-item end -->
		...
		<section class="pos-rel section-bg-dark-2">
			...
			<div class="pos-rel padding-top-bottom-60">
				<!-- title start -->
				<h2 class="headline-l text-center hidden-box margin-top-bottom-60">
					<span class="anim-slide js-scrollanim text-color-red">General Areas</span>
				</h2><!-- title end -->
						...
						<div class="js-isotope-grid-box container full padding-top-30">
							...
							<!-- grid-item start -->
							<div class="padding-top-40 grid-item-50-50-100 js-isotope-grid-item margin-top-30">
								<a href="{{ asset('assets/images/Studios/10.png') }}"
									class="grid-margin-box js-photo-popup js-pointer-zoom">
									<div class="anim-img-scale js-img-scale">
										<img class="anim-img-scale__inner"
											src="{{ asset('assets/images/Studios/10.png') }}"
							...
							<!-- grid-item start -->
							<div class="padding-top-40 grid-item-50-50-100 js-isotope-grid-item margin-top-30">
								<a href="{{ asset('assets/images/Studios/11.png') }}"
									class="grid-margin-box js-photo-popup js-pointer-zoom">
									<div class="anim-img-scale js-img-scale">
										<img class="anim-img-scale__inner"
											src="{{ asset('assets/images/Studios/11.png') }}"
		...
		<section class="pos-rel section-bg-dark-2">
			...
			<div class="pos-rel padding-top-bottom-60">
				<!-- title start -->
				<h2 class="headline-l text-center hidden-box margin-top-bottom-60">
					<span class="anim-slide js-scrollanim text-color-red">Live OB Van Production</span>
				</h2><!-- title end -->
