...
<body class="flex w-full">
    ...
    <div class="w-full h-screen overflow-y-auto  ">
        ...
        <div class="flex-1 p-10 w-4/6">
            ...
            <h1 class="text-2xl font-bold mb-6">Add Company Logo</h1>
...
@endif
            <!-- Form -->
            <form action="{{ route('pcompanies.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
...
<script>
    document.getElementById('upload').addEventListener('change', function() {
        ...
        document.getElementById('file-names').textContent = fileNames.length > 0 ? fileNames.join(', ') : 'No files selected';
    });
