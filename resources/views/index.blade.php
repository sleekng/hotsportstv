	...
	<main class="js-animsition-overlay" data-animsition-overlay="true">
				...
				<div class="swiper-slide">
					...
					<div class="flex-min-height-100vh pos-rel" data-swiper-parallax-x="30%">
						<div class="container small text-center padding-top-bottom-120 flex justify-center flex-col items-center">
							...
							<h2 class="headline-s">
								<span class="hidden-box d-block">
									<span class="anim-slide tr-delay-02">Creative marketing company boasting over</span>
								</span>
								<span class="hidden-box d-block">
				...
				<div class="swiper-slide">
					...
					<div class="flex-min-height-100vh pos-rel" data-swiper-parallax-x="30%">
						<div class="container small text-center padding-top-bottom-120 flex justify-center flex-col items-center">
							...
							<div class="margin-top-30 anim-fade tr-delay-08">
								<a href="javascript:void(0);" id="mpopupLink5" class="ellipse-btn_red js-pointer-large">
			...
			<div class="pos-rel padding-top-bottom-120">
				...
				<div class="container flex-container padding-bottom-150 px-4" style="justify-content: space-evenly;">
					...
					<div class="six-columns hs-mobile">
						<div class="">
							<p class="body-text-xxl anim-text-reveal js-scrollanim margin-top-40">HS Media Group is the holding
						...
						<article class="four-columns column-100-100  js-scrollanim">
							<div class="column-l-r-margin-10-999 hover-box pos-rel">
								<a href="Primedia" class="d-block hidden-box js-pointer-large js-animsition-link">
									...
									<!-- bg-overlay -->
									<div class="bg-overlay-blackish"></div>
									<h3 class="headline-sm pos-abs pos-left-bottom list list_margin-1px hover-move-up2">
										<span class="list__item">
											<span class="hidden-box d-inline-block">
								...
								<ul class="pos-abs pos-left-bottom">
									<li class="list__item">
										<a href="#" class="subhead-mm hover-text-fill js-pointer-small margin-top-10"
		...
		<div class="mt-8 flex justify-center space-x-2">
			...
			{{ $posts->links() }}
						...
						<script>MediumWidget.Init({renderTo: '#medium-widget', params: {"resource":"https://medium.com/@petalpurpose","postsPerLine":3,"limit":10,"picture":"big","fields":["description","author","publishAt"],"ratio":"square"}})</script>
			...
			<div class="mpopup-content">
				...
				<div class="mpopup-main">
					...
					<div class="container small padding-top-bottom-60 form-box">
						<h4 class="headline-xs text-center text-color-red">Kindly Drop Your Contact Details.<br> We Will
						...
						<form action="#" method="post" name="formobrsv" id="send_form"
							...
							<div class="nine-columns" style="margin: auto;">
								<div class="column-r-margin-10">
									<input type="text" name="Message" placeholder="Leave Us a Message" id="Message" required
										class="form-input form-input_border js-pointer-small">
								</div>
							</div><!-- column end -->
							<!-- column start -->
		...
		<div class="pos-rel flex-min-height-100vh">
			...
			<div class="container padding-top-bottom-120">
				...
				<div class="flex-container flex-align-center">
					...
					<div class="four-columns footer-nav-mobile-padding">
						<ul class="column-l-r-margin-10 footer-nav-list js-footer-hover-box ">
							...
							<li>
								<a href="About-Us"
									class="footer-nav__btn js-pointer-small js-footer-hover-link subhead-l">About Us</a>
							</li>
							<li>
				...
				<div class="flex-container flex-justify-center padding-top-30">
					...
					<div class="four-columns column-50-100 padding-top-60 footer-phone">
						<div class="column-l-r-margin-10">
							...
							<div class="margin-top-10">
								<a href="#" class="subhead-xxs text-color-white text-hover-to-white">+234 803 0945
									660</a><br>
								<a href="#" class="subhead-xxs text-color-white text-hover-to-white">+234 809 7869
									971</a>
							</div>
						</div>
					</div><!-- column end -->
				...
				<div class="footer-copyright text-center pos-abs pos-bottom-center">
					...
					<p class="copyright-style">
						<a href="/login"
							class="text-weight-700 js-pointer-small">Admin Login</a>
					</p>
