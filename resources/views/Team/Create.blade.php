...
<body class="flex w-full">
    ...
    <div class="w-full h-screen overflow-y-auto">
        ...
        <div class="flex-1 p-10 w-4/6">
            <h1 class="text-2xl font-bold mb-6">Create Team Member</h1>
...
@endif
            <form class="space-y-4 mt-4" action="{{ route('team.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="text" name="name" placeholder="Team Member's Name" class="w-full p-2 border border-gray-300 rounded" required>
                <input type="text" name="role" placeholder="Role / Designation" class="w-full p-2 border border-gray-300 rounded" required>
