        ...
        <div class="flex-1 p-10 w-full">
            <div class="flex-1 p-6">
                ...
                <div class="flex justify-between items-center my-6">
                    ...
                    <a href="{{ route('companies.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded-lg">Add
                        New</a>
                        ...
                        <div class="border-t item flex justify-between items-center bg-white p-4 hover:bg-gray-200">
                            ...
                            <div class="actions ml-6">
                                <div class="w-full flex mt-2">
                                    ...
                                    <form action="{{ route('companies.destroy', $company->id) }}" method="POST" onsubmit="confirmDelete(event)"
                                        class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
